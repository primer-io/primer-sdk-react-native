...
export function PrimerCheckoutProvider({
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (!cancelled) {
          setState((prev) => ({ ...prev, isBanksLoading: false }));
        }
      }
    })();
  ...
  //
  // Keyed on `activeKlarnaMethod` (set by the Klarna screen / usePrimerKlarna), it provides a
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (!cancelled) {
          setState((prev) => ({ ...prev, isKlarnaLoading: false }));
        }
      }
    })();
