...
export let primerSettings: PrimerSettings | undefined;
    ...
    try {
      ...
      let implementedRNCallbacks: PrimerImplementedRNCallbacks = {
        onAvailablePaymentMethodsLoad:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onAvailablePaymentMethodsLoad !== undefined || false,
        onTokenizationStart:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onTokenizationStart !== undefined || false,
        onTokenizationSuccess:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onTokenizationSuccess !== undefined || false,
        ...
        onCheckoutAdditionalInfo:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onCheckoutAdditionalInfo !== undefined || false,

        onError: primerSettings?.headlessUniversalCheckoutCallbacks?.onError !== undefined || false,
        onCheckoutComplete:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onCheckoutComplete !== undefined || false,
        onBeforeClientSessionUpdate:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onBeforeClientSessionUpdate !== undefined || false,

        onClientSessionUpdate:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onClientSessionUpdate !== undefined || false,
        onBeforePaymentCreate:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onBeforePaymentCreate !== undefined || false,
        onPreparationStart:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onPreparationStart !== undefined || false,

        onPaymentMethodShow:
          primerSettings?.headlessUniversalCheckoutCallbacks?.onPaymentMethodShow !== undefined || false,
        onDismiss: false,
      };
      ...
      if (implementedRNCallbacks.onBeforeClientSessionUpdate) {
        RNPrimerHeadlessUniversalCheckout.addListener('onBeforeClientSessionUpdate', () => {
      ...
      try {
        ...
        if (res.availablePaymentMethods) {
          ...
          const err = new PrimerError(
            'primer-rn-sdk',
            undefined,
            'Failed to find availablePaymentMethods',
            'Create another client session',
            undefined
          );
          reject(err);
        }
