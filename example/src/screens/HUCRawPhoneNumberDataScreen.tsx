...
export const HUCRawPhoneNumberDataScreen = (props: any) => {
  ...
  useEffect(() => {
    createClientSession().then((session) => {
      ...
      HeadlessUniversalCheckout.startWithClientToken(
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImtpZCI6ImNsaWVudC10b2tlbi1zaWduaW5nLWtleSJ9..m0_70Z1uO1PtV3Y38TyH5zU9WqcuMxKuBQLyi61RGOY",
        settings
      )
  ...
  const startHUCRawDataManager = async () => {
    try {
      ...
      let rawCardData: PrimerRawPhoneNumberData = {
        phoneNumber: "",
      };
      await HeadlessUniversalCheckoutRawDataManager.setRawData(rawCardData);

      setTimeout(async () => {
        rawCardData.phoneNumber = "+628";
        await HeadlessUniversalCheckoutRawDataManager.setRawData(rawCardData);

        setTimeout(async () => {
          rawCardData.phoneNumber = "+628888";
          await HeadlessUniversalCheckoutRawDataManager.setRawData(rawCardData);

          setTimeout(async () => {
            rawCardData.phoneNumber = "+62888338";
            await HeadlessUniversalCheckoutRawDataManager.setRawData(
              rawCardData
            );

            setTimeout(async () => {
              rawCardData.phoneNumber = "+628774494404";
              await HeadlessUniversalCheckoutRawDataManager.setRawData(
                rawCardData
              );
