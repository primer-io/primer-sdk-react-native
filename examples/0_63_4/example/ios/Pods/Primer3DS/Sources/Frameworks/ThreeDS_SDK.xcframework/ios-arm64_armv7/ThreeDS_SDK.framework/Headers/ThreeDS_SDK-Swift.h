...
void callbackDebugger(void);
void callbackIntegrity(void);
void callbackJailbreak(void);
NSArray<NCAWarning *> * _Nonnull detectedWarnings(void) SWIFT_WARN_UNUSED_RESULT;
#if __has_attribute(external_source_symbol)
